...
export const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Share your presentations as a universally viewable PDF. Learn how to export slides, preserve animation notes, and control quality settings.",
        ...
        <div className="container-main max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-10">
              Expert guides to help you work smarter with PDF files — powered by PDFHelperEdit.
            </p>
          </motion.div>
              ...
              >
                <Link to={`/blog/${post.slug}`} className="no-underline block group">
                  <div className="glass-card p-6 hover:shadow-lg transition-all">
                    ...
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 group-hover:text-primary transition-colors mb-2">
                      {post.title}
                    </h2>
